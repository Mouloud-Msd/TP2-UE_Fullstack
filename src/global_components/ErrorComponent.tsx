...
switch (status) {
    case 400: 
    title = "Bad Request";
    description = message || "The server could not understand the request due to invalid syntax.";
    break;
    case 404:
    ...
    case 500:
        ...
        description = message || "The server has encountered a situation it doesn't know how to handle.";
        break;
